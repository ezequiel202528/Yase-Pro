...
//         ? formatarComHora(item.updated_at)
//         : "Sem alterações";
...
// main.js - Parte da função registrarItem
...
//     // 1. MONTAGEM DO OBJETO DE DADOS (Mantendo sua estrutura original)
//     const dados = {
...
//     // 2. LÓGICA DE SALVAMENTO (DECIDE ENTRE NOVO OU EDITAR)
...
//       // Reseta o estado global de edição
//       window.editandoID = null;

//       // Restaura o visual do botão para o modo original
...
//     // Atualiza o selo apenas se for um novo registro (opcional)
//     if (!window.editandoID && typeof atualizarSelo === "function") {
//       atualizarSelo();
//     }
